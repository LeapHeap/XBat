...
set "CFLAGS=-Os -DMODE_FULL -DUNICODE -D_UNICODE"
...
gcc -o "%STUB_X64_OUTPUT_PATH%\stub_full.bin" ^
    main.o stub_full.o crypto.o Utils.o LzmaDec.o ^
    %LDFLAGS% ^
...
echo [!] Done! Output saved to: %STUB_X64_OUTPUT_PATH%\stub_full.bin